...
- ViewModel/state dùng model domain, không import API/cache/model/exception từ data. Repository chọn nguồn dữ liệu và chuyển lỗi sang MovieLoadError; ViewModel giữ job/generation và state UI.
