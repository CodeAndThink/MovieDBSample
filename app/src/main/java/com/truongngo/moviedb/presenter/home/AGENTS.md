...
- Luồng: HomeFragment → HomeEvent → HomeViewModel → ApiClients + HomeCache (Room); HomeState/HomeEffect.
...
- Test: HomeViewModelTest, HomeCacheDatabaseTest, HomeInstrumentedTest; chú ý refresh race, retry, banner wrap.
